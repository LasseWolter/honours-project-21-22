...
icsi, chan_idx_map = prepare_icsi(audio_dir='data/speech/test', transcripts_dir='data/transcripts/test', output_dir='lhotse_manifests')
...
cuts = start_set.compute_and_store_features(
    extractor=Fbank(),
    storage_path='test'
)
