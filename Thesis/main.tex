...
This project narrows the scope to a machine learning model for laughter detection. Real-time constraints are considered theoretically but adapting the model implementation for real-time usage is left for future work.
...
\begin{table}[h!]
    ...
    \hline
    \end{tabular}
    \caption{Using Librosa to load a one-second segment from different offsets of an \textit{.sph-file}. Channel loaded: \texttt{Btr002:chan3}. Duration: 5318s. Test code: \href{https://github.com/LasseWolter/laughter-detection-icsi/tree/main/misc_scripts}{naive librosa-test}.}
