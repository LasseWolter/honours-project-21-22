...
\begin{figure}[h!]
    \centering
    \includegraphics[width=8cm]{imgs/conf_matrix/init_eval_all.png}
    \caption{Confusion matrix from final evaluation (\autoref{tab:final-eval}), evaluated on the whole ICSI corpus. \confmatrixcaption}
...
\hspace*{-1cm}                                                           
\subfloat[baseline]{\includegraphics[width = 3.5in]{imgs/conf_matrix/exp1-random/baseline.png}}\\ 
\end{tabular}
...
\begin{tabular}{cc}
\hspace*{-2cm}                                                           
\subfloat[model-a]{\includegraphics[width = 3.5in]{imgs/conf_matrix/exp2-structured/model-a.png}} &
\hspace*{-1cm}                                                           
\subfloat[model-b]{\includegraphics[width = 3.5in]{imgs/conf_matrix/exp2-structured/model-b.png}}\\ 
\hspace*{-2cm}                                                           
\subfloat[model-c]{\includegraphics[width = 3.5in]{imgs/conf_matrix/exp2-structured/model-c.png}} &
\hspace*{-1cm}                                                           
\subfloat[baseline]{\includegraphics[width = 3.5in]{imgs/conf_matrix/exp2-structured/1_to_20_random.png}}\\ 
\end{tabular}
...
To conclude this section, I provide a baseline (\autoref{tab:rtf}) for future work that estimates the latency of the model from \citet{gillick2021robust} by computing the real-time-factor(RTF). 
